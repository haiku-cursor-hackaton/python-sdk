...
name: wire-genko-sdk
description: >-
  Integrate the Genko SDK (genko-sdk) into a Python/FastAPI store: install,
  implement MerchantAdapter, mount UCP REST routers, configure Genko platform
  env vars, and verify discovery. Use when wiring UCP, adding agent checkout,
  installing genko-sdk, merchant adapter, UCP_GATEWAY_API_KEY, or onboarding a
  store to the Genko platform.
---
...
Read these only if you need detail beyond this skill:
...
- Full spec: [`docs/SDK_PRD.md`](../../docs/SDK_PRD.md)
...
**In scope for this skill:** merchant-side SDK install, adapter, FastAPI wiring,
...
When the user asks to integrate UCP into *their* store, follow this checklist
end-to-end. Prefer matching patterns from the Lithe reference implementation over
